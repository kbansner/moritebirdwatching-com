    ...
    en: [
        {
            ...
            description: 'A critically endangered cockatoo found nowhere else on earth. The villagers are now playing a vital role in protecting this species from illegal trading.',
            image: '../src/imports/cockatoo.jpg'
        },
        {
    ...
    id: [
        {
            ...
            scientific: 'Cacatua moluccensis',
            description: 'Kakatua yang terancam punah yang hanya ditemukan di sini. Penduduk desa kini memainkan peran penting dalam melindungi spesies ini dari perdagangan ilegal.',
            image: '../src/imports/cockatoo.jpg'
        },
        {
    ...
    en: [
        {
            ...
            duration: '3 - 6 hours',
            groupSize: 'No limit',
            description: 'We will take you for a walk between villages where we will point out local flora, fauna and the villagers\' age-old farming techniques. Bring your binoculars as we are very likely to see birds along the way. Trips can be tailored to your specific interests and energy level.'
        },
        {
            title: 'Visit to Viewing Platforms',
            duration: '1 - 3 hours',
            groupSize: 'Up to 20 people',
            description: 'Above the village of Masihulan are two viewing platforms surrounded by parrots\' nests. It\'s a steep 15 minute hike up from the main road, but once you\'re there the view is spectacular.'
        },
        {
            title: 'Canopy Platform Trips',
            duration: 'Several hours to overnight',
            groupSize: 'Up to 10 people',
            description: 'Sleep in a tree. Wake up before dawn to watch the neighboring parrots begin their day by stretching and preening.'
        },
        {
            title: 'Api Lima',
            duration: '2 days',
            groupSize: 'Up to 6 people',
            description: 'This shallow cave offers a high lookout over the forest canopy. It\'s a two to three hour hike from the quarry where the road ends. This high cave is a great place to relax and view Cockatoos, Lories, and Hornbills without having to climb up to the tree platforms.'
        },
        {
            title: 'Custom Tree Platforms',
            duration: '3 - 5 days',
            groupSize: 'Small',
            description: 'If there\'s a specific bird you would like to see, our guides can try to locate them and build a concealed platform for you near their sleeping trees or feeding spots.'
        },
        {
            title: 'Trekking Across Seram',
            duration: '7 days',
            groupSize: 'Up to 6 people',
            description: 'This is a very strenuous hike which requires a number of porters to carry your food as well as things to barter on your way through the Manusela National Park. For the first four days you\'ll be staying in villages enjoying the warm hospitality of their chiefs. The last two or three nights on the way down from the village of Manusela to the southern coast, you\'ll sleep in caves cut into the rock face.'
        }
    ],
    id: [
        {
            ...
            description: 'Kami akan mengajak Anda berjalan-jalan antar desa di mana kami akan menunjukkan flora lokal, fauna, dan teknik pertanian kuno penduduk desa. Bawa teropong Anda karena kami sangat mungkin melihat burung di sepanjang jalan. Perjalanan dapat disesuaikan dengan minat dan tingkat energi spesifik Anda.'
        },
        {
            title: 'Kunjungan ke Platform Pengamatan',
            duration: '1 - 3 jam',
            groupSize: 'Hingga 20 orang',
            description: 'Di atas desa Masihulan terdapat dua platform pengamatan yang dikelilingi oleh sarang burung beo. Ini adalah pendakian curam 15 menit dari jalan utama, tetapi begitu Anda sampai di sana pemandangannya spektakuler.'
        },
        {
            title: 'Perjalanan Platform Kanopi',
            duration: 'Beberapa jam hingga semalam',
            groupSize: 'Hingga 10 orang',
            description: 'Tidur di pohon. Bangun sebelum fajar untuk menyaksikan burung beo tetangga memulai hari mereka dengan meregangkan dan membersihkan bulu.'
        },
        {
            title: 'Api Lima',
            duration: '2 hari',
            groupSize: 'Hingga 6 orang',
            description: 'Gua dangkal ini menawarkan pemandangan tinggi di atas kanopi hutan. Ini adalah pendakian dua hingga tiga jam dari tambang di mana jalan berakhir. Gua tinggi ini adalah tempat yang bagus untuk bersantai dan melihat Kakatua, Lories, dan Hornbills tanpa harus naik ke platform pohon.'
        },
        {
            title: 'Platform Pohon Kustom',
            duration: '3 - 5 hari',
            groupSize: 'Kecil',
            description: 'Jika ada burung tertentu yang ingin Anda lihat, pemandu kami dapat mencoba menemukan mereka dan membangun platform tersembunyi untuk Anda di dekat pohon tidur atau tempat makan mereka.'
        },
        {
            title: 'Trekking Melintasi Seram',
            duration: '7 hari',
            groupSize: 'Hingga 6 orang',
            description: 'Ini adalah pendakian yang sangat berat yang membutuhkan sejumlah porter untuk membawa makanan Anda serta barang untuk barter dalam perjalanan Anda melalui Taman Nasional Manusela. Selama empat hari pertama Anda akan tinggal di desa menikmati keramahan hangat kepala suku mereka. Dua atau tiga malam terakhir dalam perjalanan turun dari desa Manusela ke pantai selatan, Anda akan tidur di gua yang dipotong ke wajah batu.'
        }
    ]
};
...
function createBirdCard(bird, index) {
    ...
    return `
        <div class="bird-card">
            ...
            <div class="p-6">
                <h3 class="text-2xl mb-2 text-[#2d4a3e] font-serif font-semibold">${bird.name}</h3>
...
function createTripCard(trip) {
    return `
        <div class="trip-card">
            <h3 class="text-2xl mb-4 text-[#2d4a3e] font-serif font-semibold">${trip.title}</h3>
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Canopy parallax scroll effect
    const canopyLayers = document.querySelector('.canopy-layers');
    const canopyBg = document.querySelector('.canopy-bg');
    const canopyMid = document.querySelector('.canopy-mid');
    const canopyFg = document.querySelector('.canopy-fg');
    const cockatoo = document.querySelector('.cockatoo-hidden');

    window.addEventListener('scroll', () => {
        const canopySection = document.querySelector('.canopy-transition');
        if (!canopySection) return;

        const rect = canopySection.getBoundingClientRect();
